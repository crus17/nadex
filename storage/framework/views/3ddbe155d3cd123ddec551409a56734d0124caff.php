    ...
    <div class="limiter">
        <div class="container-form user-auth" >
				<div class="section-form-box">
                            <!-- Logo Starts -->
                            <!--<a href="<?php echo e(url('/')); ?>" class="text-center"><img src="<?php echo e($settings->site_address); ?>/cloud/app/images/<?php echo e($settings->logo); ?>" alt="<?php echo e($settings->site_name); ?>" class="text-center"> </a>-->
                            <div>
                                <a href="<?php echo e(url('/')); ?>">
                                  <!--<span style="color:#04b9f4;font-size:30px;" class="w3-hide-large"><img src="<?php echo e(asset ('temp_new/images/log.png')); ?>"><?php echo e($settings->site_name); ?></span>-->
                                  <span style="color:#04b9f4;font-size:30px;" class="w3-hide-large"><img src="<?php echo e(asset ('home/images/logo-white.png')); ?>" width="320"></span>
                                </a>
                            </div>
                            <!-- Logo Ends -->
