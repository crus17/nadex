									...
									<tbody> 
										...
										<tr> 
											...
											<?php if($deposit->status == "Approved"): ?>
												<td class="fw-bold text-success"><?php echo e($deposit->status); ?></td> 
											<?php elseif($deposit->status == "Declined"): ?>
												<td class="fw-bold text-danger"><?php echo e($deposit->status); ?></td> 
											<?php else: ?>
												<td class="fw-bold"><?php echo e($deposit->status); ?></td> 
											<?php endif; ?>
											<td><?php echo e(\Carbon\Carbon::parse($deposit->created_at)->toDayDateTimeString()); ?></td> 
											<td>
											<?php if($deposit->status =="Pending"): ?> 
											<a class="btn btn-success btn-sm m-1" href="<?php echo e(url('admin/dashboard/pwithdrawal')); ?>/<?php echo e($deposit->id); ?>">Approve</a>
											<a class="btn btn-danger btn-sm m-1" href="<?php echo e(url('admin/dashboard/dwithdrawal')); ?>/<?php echo e($deposit->id); ?>">Decline</a>
											<?php endif; ?>
